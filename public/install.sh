...
echo ""
echo "  ${GREEN}codeskills status${RESET}           # 查看状态"
echo "  ${GREEN}codeskills list${RESET}             # 列出本地技能"
echo "  ${GREEN}codeskills list --remote${RESET}    # 浏览远程技能"
echo "  ${GREEN}codeskills search <关键词>${RESET}  # 搜索远程技能"
echo "  ${GREEN}codeskills install <技能>${RESET}   # 安装技能"
echo "  ${GREEN}codeskills activate <组>${RESET}   # 激活分组"
echo "  ${GREEN}codeskills web${RESET}              # Web 管理面板"
