...
- Compared to asking AI directly: platform-specific formatting (MJ params, SD quality tags, negative prompts), 内置 style presets, and 批量 variation generation
...
prompt.sh 镜像 "主题" [--style realistic|anime|oil|watercolor|3d|pixel|cyberpunk|fantasy]
